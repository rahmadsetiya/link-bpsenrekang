...
function handleSearch() {
    router.get(route("dashboard.links.index"), {
...
function bulkDelete() {
    ...
    router.post(
        route("dashboard.links.bulk-destroy"),
        { ids: selected.value },
        {
            onSuccess: () => {
                selected.value = [];
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-4 flex gap-2">
                    <div class="flex-1">
                        <input
                            v-model="searchQuery"
                            type="text"
                            placeholder="Cari berdasarkan nama atau URL..."
                ...
                >
                    Menampilkan <strong>{{ links.length }}</strong> dari
                ...
                >
                    ...
                    <div class="flex gap-2">
                        <button
                            @click="openBulkEdit('year')"
                            class="rounded-lg border border-blue-200 bg-white px-3 py-1 text-xs font-medium text-blue-700 hover:bg-blue-50 dark:border-blue-700 dark:bg-transparent dark:text-blue-300"
                        >
                            Ubah Tahun
                        </button>
                        <button
                            @click="openBulkEdit('tags')"
                            class="rounded-lg border border-blue-200 bg-white px-3 py-1 text-xs font-medium text-blue-700 hover:bg-blue-50 dark:border-blue-700 dark:bg-transparent dark:text-blue-300"
                        >
                            Ubah Tag
                        </button>
                        <button
                            @click="openBulkEdit('status')"
                            class="rounded-lg border border-blue-200 bg-white px-3 py-1 text-xs font-medium text-blue-700 hover:bg-blue-50 dark:border-blue-700 dark:bg-transparent dark:text-blue-300"
                        >
                            Ubah Status
                        </button>
                        <button
                            @click="bulkDelete"
                            class="rounded-lg border border-red-200 bg-white px-3 py-1 text-xs font-medium text-red-600 hover:bg-red-50 dark:border-red-800 dark:bg-transparent dark:text-red-400"
                        >
                            Hapus
                        </button>
                    </div>
                    <button
                        @click="selected = []"
                        class="ms-auto text-xs text-gray-400 hover:text-gray-600"
                    >
                        Batal
                    </button>
                </div>
                    ...
                    <table class="w-full text-sm">
                        ...
                        >
                            <tr>
                                ...
                                <th
                                    class="hidden px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-300 md:table-cell"
                                >
                                    URL
                                </th>
                                <th
                                    class="hidden px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-300 sm:table-cell"
                                >
                                    Tahun
                                </th>
                                <th
                                    class="hidden px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-300 lg:table-cell"
                                >
                                    Tag
                                </th>
                                <th
                                ...
                                <th
                                    class="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-300"
                                >
                                    Aksi
                                </th>
                            </tr>
                        ...
                        >
                            <tr v-if="links.length === 0">
                                ...
                                >
                                    Belum ada tautan. Klik "+ Tambah Tautan"
                                    untuk mulai.
                                </td>
                            </tr>
                            <tr
                            ...
                            >
                                ...
                                <td class="hidden px-4 py-3 md:table-cell">
                                    <a
                                        :href="link.url"
                                        target="_blank"
                                        class="truncate text-blue-600 hover:underline dark:text-blue-400 max-w-xs block"
                                    >
                                        {{ link.url }}
                                    </a>
                                </td>
    ...
    <Teleport to="body">
        ...
        >
            ...
            >
                <h3
                    class="mb-5 text-base font-semibold text-gray-800 dark:text-gray-100"
                >
    ...
    <Teleport to="body">
        ...
        >
            ...
            />
            <div
                class="relative z-10 w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-900"
            >
                <h3
                    class="mb-4 text-base font-semibold text-gray-800 dark:text-gray-100"
                >
                    Ubah
                    {{
                        bulkAction === "year"
                ...
                <div v-if="bulkAction === 'tags'" class="mb-4">
                    <label
                        class="mb-2 block text-xs font-medium text-gray-600 dark:text-gray-400"
                        >Pilih Tag (akan mengganti tag lama)</label
                    >
                    <div class="flex flex-wrap gap-2">
                        <button
                            v-for="tag in tags"
                            ...
                            class="rounded-full border px-3 py-1 text-xs font-medium transition"
                            :class="
                                bulkForm.tag_ids.includes(tag.id)
                                    ? 'border-blue-500 bg-blue-500 text-white'
                                    : 'border-gray-200 bg-white text-gray-600 hover:border-blue-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400'
                            "
                        >
